...
const UITesting: Component = () => {
  return (
    <div>
      <Header />
      <div>
        <p>Ythe ui component tesing</p>
        {/*  */}
            ...
            <section id="text">
              ...
              <article id="text__details">
                ...
                <details>
                  ...
                  <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum, odio! Odio natus ullam ad
                    quaerat, eaque necessitatibus, aliquid distinctio similique voluptatibus dicta
                    consequuntur animi. Quaerat facilis quidem unde eos! Ipsa.
                  </p>
                </details>
                <footer>
                  <p>
              ...
              <form>
                ...
                <fieldset id="forms__checkbox">
                  ...
                  <ul>
                    <li>
                      <label for="checkbox1">
                        <input id="checkbox1" name="checkbox" type="checkbox" checked={true} /> Choice A
                      </label>
                    </li>
                    <li>
                      <label for="checkbox2">
                ...
                <fieldset id="forms__radio">
                  ...
                  <ul>
                    <li>
                      <label for="radio1">
                        <input id="radio1" name="radio" type="radio" checked={true} /> Option 1
                      </label>
                    </li>
                    <li>
                      <label for="radio2">
